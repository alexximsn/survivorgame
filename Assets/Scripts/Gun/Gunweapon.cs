...
public class Gunweapon : weapons
{
    ...
    public override void UpdateStats(PlayerStatsManager playerStatsManager)
    {
        ...
        damage = Mathf.RoundToInt(damage * (1+playerStatsManager.GetStatValue(Stat.攻击)/100));
        attackDelay/=1+(playerStatsManager.GetStatValue(Stat.攻击速度)/100);
        critialChance = Mathf.RoundToInt(critialChance * (1 + playerStatsManager.GetStatValue(Stat.暴击率) / 100));
        critialPercent += playerStatsManager.GetStatValue(Stat.暴击伤害);
